...
export const PAYMENTS_FREE_TRIAL_PATH = '/payments/free-trial/:moduleName';
...
export const BULK_PRINT_PACKAGE_SALES_PATH = '/sales/bulk/print/package';
export const BULK_PRINT_PACKAGE_REPAIRS_PATH = '/repairs/bulk/print/package';
export const BULK_PRINT_PACKAGE_PURCHASES_PATH = '/purchases/bulk/print/package';
