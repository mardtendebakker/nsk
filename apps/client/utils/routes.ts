...
export const CUSTOMERS_CONTACTS_EDIT = '/customers/contacts/:id';
export const SUPPLIERS_CONTACTS_EDIT = '/suppliers/contacts/:id';
export const CUSTOMERS_EMAILS_NEW = '/customers/emails/new';
export const CUSTOMERS_EMAILS = '/customers/emails';
export const SUPPLIERS_CONTACTS = '/suppliers/contacts';
export const SUPPLIERS_CONTACTS_NEW = '/suppliers/contacts/new';
