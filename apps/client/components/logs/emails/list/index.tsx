...
import { LOGS_EMAILS_PATH } from '../../../../utils/axios';
...
export default function ListContainer() {
  ...
  const { data: { data = [], count = 0 } = {}, call, performing } = useAxios<undefined | { data?: EmailLog[], count?: number }>(
    'get',
    LOGS_EMAILS_PATH.replace(':id', ''),
    {
