...
import { LOGS_ACTIVITY_PATH } from '../../../../utils/axios';
...
export default function ListContainer() {
  ...
  const { data: { data = [], count = 0 } = {}, call, performing } = useAxios<undefined | { data?: ActivityLog[], count?: number }>(
    'get',
    LOGS_ACTIVITY_PATH.replace(':id', ''),
    {
