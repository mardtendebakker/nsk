...
const translation = {
  ...
  retailPriceExtVat: 'Preço de retalho sem IVA',
  retailPriceInclVat: 'Preço de retalho com IVA',
  listPriceInclVat: 'Preço de tabela com IVA',
  listPriceExtVat: 'Preço de tabela sem IVA',
  ...
  productStatusForm: {
    ...
    translations: {
      label: 'Traduções',
      placeholder: 'Digite o nome traduzido do status do produto',
    },
  },
  orderStatusForm: {
    mailBody: {
    ...
    mailBodyVariables: {
      ...
      pickupDate: '{{pickupDate}} A data de coleta planejada.',
      orderDate: '{{orderDate}} A data em que o pedido foi criado.',
      supplierName: '{{supplierName}} Nome do fornecedor.',
  ...
  createInvoiceConfirmationQuestion: 'Por favor, verifique novamente as informações antes de criar uma fatura.',
