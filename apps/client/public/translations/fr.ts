const translation = {
  ...
  selectProductSubType: 'Sélectionner le sous-type de produit',
  productSubTypes: 'Sous-types de produit',
  newProductSubType: 'Nouveau sous-type de produit',
  createProductSubType: 'Créer un sous-type de produit',
  editProductSubType: 'Modifier le sous-type de produit',
  productSubTypesList: {
    search: {
  ...
  status: 'Statut',
  transport: 'Transport',
  priceInclVat: 'Prix TTC',
  priceExclVat: 'Prix HT',
  salePriceInclVat: 'Prix de vente TTC',
  salePrice: 'Prix de vente',
  discount: 'Remise',
  total: 'Total',
  totalExtVat: 'Total hors TVA',
  vatValue: 'Montant TVA',
  vat: 'TVA',
  city: 'Ville',
  country: 'Pays',
  type: 'Type',
  retailPrice: 'Prix de détail',
  retailPriceExtVat: 'Prix de détail HT',
  retailPriceInclVat: 'Prix de détail TTC',
  listPriceInclVat: 'Prix catalogue TTC',
  listPriceExtVat: 'Prix catalogue HT',
  quantity: 'Quantité',
  ...
  none: 'Aucun support de données',
  format: 'Format',
  statement: 'Déclaration de destruction',
  degauss: 'Démagnétiser par EMP',
  eraseData: 'Supprimer les données certifiées',
  attributeForm: {
    code: {
      label: 'Code',
  ...
  productStatusForm: {
    ...
    translations: {
      label: 'Traductions',
      placeholder: 'Entrez le nom traduit du statut de produit',
    },
  },
  orderStatusForm: {
    mailBody: {
  ...
  createInvoiceConfirmationQuestion: 'Veuillez vérifier à nouveau les informations avant de créer une facture.',
