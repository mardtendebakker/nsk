const translation = {
  ...
  status: 'الحالة',
  transport: 'النقل',
  priceInclVat: 'السعر شامل ضريبة القيمة المضافة',
  priceExclVat: 'السعر غير شامل ضريبة القيمة المضافة',
  retailPriceExtVat: 'سعر التجزئة باستثناء ضريبة القيمة المضافة',
  retailPriceInclVat: 'سعر التجزئة شامل ضريبة القيمة المضافة',
  listPriceInclVat: 'سعر القائمة شامل ضريبة القيمة المضافة',
  listPriceExtVat: 'سعر القائمة باستثناء ضريبة القيمة المضافة',
  salePriceInclVat: 'سعر البيع شامل ضريبة القيمة المضافة',
  salePrice: 'سعر البيع',
  discount: 'الخصم',
  total: 'الإجمالي',
  totalExtVat: 'الإجمالي بدون ضريبة القيمة المضافة',
 ...
 'أدخل الكود',
  ...
  createInvoiceConfirmationQuestion: 'يرجى مراجعة المعلومات مرة أخرى قبل إنشاء فاتورة.',
