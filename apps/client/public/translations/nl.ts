const translation = {
  ...
  productEditConfirmation: 'Bent u er zeker van, dat u de verkoopprijs correct heeft ingevuld? Verkoopprijs:',
  ...
  searchBySerialNumberOrName: 'Zoek op serienummer of naam',
  contact: 'Contact',
  ...
  saveEmail: 'Email opslaan',
  saveSales: 'Verkooporder opslaan',
  content: 'Inhoud',
  ...
  deleteResourceContent: 'Deze actie kan niet ongedaan worden gemaakt en alle gebruikers verliezen de toegang ertoe.',
