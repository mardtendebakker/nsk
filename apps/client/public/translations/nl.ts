const translation = {
  ...
  orderMightShouldChangeWarning: 'Controleer of de bestel status nog klopt.',
  code: 'Code',
  ...
  forgotPasswordMessage: 'U ontvangt een verificatiecode in de e-mail, die betrekking heeft op de gebruikersnaam of het e-mailadres dat u gaat gebruiken.',
  ...
  printBarcodes: 'Streepjescode afdrukken',
  ...
  deliveryDetails: 'Leverings gegevens',
  ...
  productTypeForm: {
    ...
    isAttribute: {
      label: 'Kan een eigenschap zijn van een ander producttype',
    },
  },
  locationForm: {
    name: {
  ...
  editProductType: 'Producttype wijzigen',
