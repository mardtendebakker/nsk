const translation = {
  ...
  saveEmail: 'ذخبره ایمیل',
  saveSales: 'ذخیره فروش ها',
  content: 'محتوا',
  recipients: 'گیرندگان',
  openRate: 'نرخ باز',
  ...
  days: 'روز ها',
  company: 'شرکت',
  upcomingDeliveries: 'تحویل های آینده',
  ...
  selectLogistic: 'انتخاب حمل و نقل',
  none: 'هیج',
  format: 'قالب',
