const translation = {
  ...
  status: 'Status',
  transport: 'Transport',
  salePriceInclVat: 'Verkaufspreis inkl. MwSt',
  salePrice: 'Verkaufspreis',
  priceInclVat: 'Preis inkl. MwSt',
  priceExclVat: 'Preis exkl. MwSt',
  discount: 'Rabatt',
  total: 'Gesamt',
  totalExtVat: 'Gesamtbetrag ohne MwSt',
  vatValue: 'MwSt-Betrag',
  vat: 'MwSt',
  city: 'Stadt',
  country: 'Land',
  type: 'Typ',
  retailPrice: 'Ladenpreis',
  retailPriceExtVat: 'Einzelhandelspreis ohne MwSt',
  retailPriceInclVat: 'Einzelhandelspreis inkl. MwSt',
  listPriceInclVat: 'Listenpreis inkl. MwSt',
  listPriceExtVat: 'Listenpreis ohne MwSt',
  quantity: 'Menge',
